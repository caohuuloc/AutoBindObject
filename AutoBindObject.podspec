...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AutoBindObject.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/AutoBindObject'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Cao Huu Loc' => 'caohuuloc@yahoo.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/AutoBindObject.git', :tag => s.version.to_s }
